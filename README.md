...
- `2. script_limpieza.python`: Incluye script en Python para la limpieza inicial de los datos. También se presenta un folder con los archivos Excel resultantes de la limpieza
  y un archivo txt con el registro de los errores detectados y cambios realizaods.
